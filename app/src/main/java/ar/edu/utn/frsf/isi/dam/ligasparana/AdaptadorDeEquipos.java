...
public class AdaptadorDeEquipos extends ArrayAdapter<Equipo> {
    ...
    public AdaptadorDeEquipos(Context context, List<Equipo> equipos) {
        //Llamada al constructor de la clase superior donde requiere el contexto, el layout y el arraylist
        super(context, R.layout.fila_inicio_ligas_categ, equipos);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (item == null) {
            ...
            item = inflater.inflate(R.layout.fila_equipo, null);
