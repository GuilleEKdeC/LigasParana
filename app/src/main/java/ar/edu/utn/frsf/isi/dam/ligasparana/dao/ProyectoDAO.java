...
/*---------------------------------- Declaración de Variables ------------------------------------*/
    ...
    /*    Cursor cursorPry = db.rawQuery("SELECT "+ProyectoDBMetadata.TablaMisPartidosMetadata._ID+" FROM "+ProyectoDBMetadata.TABLA_MISPARTIDOS,null);
        ...
        cursorPry.close();*/
        Cursor cursor = null;
        cursor = db.rawQuery(_SQL_TAREAS_X_MISPARTIDOS,null);  //new String[]{idPry.toString()}
     return cursor;
    }
...
/*        valores.put(ProyectoDBMetadata.TablaMisPartidosMetadata.NOTIFICAR,"TRUE");
